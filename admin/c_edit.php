...
if(isset($_POST['submit'])){
    ...
    if($gambar != ""){
        ...
        $namaBaru = $data['gambar']; // pakai gambar lama
    }
...
<head>
    <meta charset="UTF-8">
    <title>Edit Produk - Redbox Frozen</title>
...
<div class="flex-1 p-8 overflow-y-auto">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-extrabold text-black tracking-tight uppercase">Edit Produk Baru</h1>
        <p class="text-gray-500">Edit detail informasi produk frozen food Anda di bawah ini.</p>
    </div>
...
class="w-full border p-3.5 rounded-xl">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="kategori" class="w-full border p-3.5 rounded-xl">
    <option value="Frozen Food" <?= $data['kategori']=='Frozen Food'?'selected':'' ?>>Frozen Food</option>
    <option value="Olahan Daging" <?= $data['kategori']=='Olahan Daging'?'selected':'' ?>>Olahan Daging</option>
    <option value="Dairy Product" <?= $data['kategori']=='Dairy Product'?'selected':'' ?>>Dairy Product</option>
</select>
                            </div>
                            <div>
...
value="<?= $data['diskon'] ?>" min="0" max="100"
class="w-full border p-3.5 rounded-xl">
                        </div>
...
class="w-full border p-3.5 rounded-xl"><?= $data['deskripsi'] ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
class="w-full border p-3.5 rounded-xl">
                ...
                <div class="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm">
                    ...
                    <div class="border-2 border-dashed border-gray-200 rounded-2xl p-4 text-center hover:border-[#C81010] transition-all group">
                        ...
                        <img src="../assets/images/<?= $data['gambar'] ?>" 
